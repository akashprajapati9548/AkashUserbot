...
async def hello(client: app, message):
    buttons = [
           [
                InlineKeyboardButton("⚡ᴅᴇᴠᴇʟᴏᴘᴇʀ 💕⚡", url="t.me/@WTF_NoHope"),
            ],
            [
                InlineKeyboardButton("⚡𝙲𝙷𝙰𝙽𝙽𝙴𝙻 💕⚡", url="t.me/AnanyaBots"),
            ],
            [
                InlineKeyboardButton("⚡𝚂𝚄𝙿𝙿𝙾𝚁𝚃 💕⚡", url="t.me/AnanyaBotSupport"),
            ],
            ]
